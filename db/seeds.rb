...
User.find_or_create_by!(
  [
    ...
    },
    {
      ...
      name: "ランド・スケープ",
      profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/icon2.png")),filename: 'work_image.jpg'),
    ...
    },
    {
      ...
      name: "ビストロあーと",
      profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/icon3.png")),filename: 'work_image.jpg'),
    ...
    },
    {
      ...
      name: "ロボ屋",
      profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/icon4.png")),filename: 'work_image.jpg'),
    ...
    },
    {
      ...
      name: "点描世界観",
      profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/icon5.png")),filename: 'work_image.jpg'),
    ...
    },
    {
      ...
      name: "青少年委員会",
      profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/icon6.png")),filename: 'work_image.jpg'),
